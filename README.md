...
See `org-agenda-files` [org-agenda-files](#orge90aa24)
...
`xdebug.file_link_format` is used by compliant apps to format a protocol uri. This is handled on my Linux system as a result of [emacsclient.desktop](#orge370ec1) documented below.
