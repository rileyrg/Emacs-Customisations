...
See `org-agenda-files` [org-agenda-files](#orgcbe7cc2)
...
`xdebug.file_link_format` is used by compliant apps to format a protocol uri. This is handled on my Linux system as a result of [emacsclient.desktop](#org898be2b) documented below.
