...
See `org-agenda-files` [org-agenda-files](#org38fc021)
...
1.  project-launch-external-script
    ...
    2.  project-launch-external-script
        ...
        includes an example calling \`project-external-terminal-script'
        
        ![img](./images/project-launch-external-script.png "two tmux instances open for two different projects")
...
### javelin - quick project aware bookmarks
...
# INFO Daemon Init File

This tangles to its own init file [init-info.el](etc/elisp/init-info.el).
...
`xdebug.file_link_format` is used by compliant apps to format a protocol uri. This is handled on my Linux system as a result of [emacsclient.desktop](#org1985565) documented below.
