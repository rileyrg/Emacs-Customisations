...
See `org-agenda-files` [org-agenda-files](#org82db38e)
...
`xdebug.file_link_format` is used by compliant apps to format a protocol uri. This is handled on my Linux system as a result of [emacsclient.desktop](#org5a19bce) documented below.
