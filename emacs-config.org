...
:END:
***** DONE JSONNavigator
CLOSED: [2021-06-10 Thu 06:15] SCHEDULED: <2021-06-08 Tue>
:PROPERTIES:
:header-args:emacs-lisp: :tangle no
:END:
:LOGBOOK:
...
#+end_src
***** lsp                                                               :lsp:
****** microsoft python language server                                 :lsp:
#+begin_src emacs-lisp
...
***** Clang provides us with some industry standard code prettiers    :trash:
:PROPERTIES:
:ID:       42ededa2-d031-47ae-9489-1bd0eec621c6
:END:
:LOGBOOK:
- State "CANCELLED"  from              [2021-06-10 Thu 22:29]
- State "CANCELLED"  from              [2021-06-10 Thu 21:36] \\
  see what lsp does on its own
:END:
