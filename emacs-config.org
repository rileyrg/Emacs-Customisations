...
** DONE error with straight in latest gcceamcs pull workaround
CLOSED: [2021-05-18 Tue 18:21]
:PROPERTIES:
:header-args:emacs-lisp: :tangle no
:END:
:LOGBOOK:
- State "DONE"       from              [2021-05-18 Tue 18:21]
:END:
...
*** rgr-early-init library
    :PROPERTIES:
    :header-args:emacs-lisp: :tangle (expand-file-name "rgr-early-init.el" elisp-dir)
    :END:
    #+begin_src emacs-lisp
...
***** find file at point - documented in the [[https://github.com/raxod502/selectrum/wiki/Additional-Configuration#complete-file-names-at-point][selectrum wiki]]
      ...
      #+begin_src emacs-lisp
        (use-package ffap
          ...
          (ffap-bindings))
      #+end_src
**** [[https://github.com/raxod502/ctrlf][ctrlf]] - back to basics search                                    :ctrlf:
     :PROPERTIES:
...
**** [[https://github.com/raxod502/prescient.el][Prescient]] provides sorting and filtering.                    :prescient:
     ...
     #+end_src
**** [[https://github.com/minad/consult][Consult]] provides various commands based on the Emacs completion function completing-read :consult:
     :PROPERTIES:
...
CLOSED: [2021-05-24 Mo 19:54]
      ...
      #+end_src
***** CANCELLED Tab Bar Mode                               :tabbar:CANCELLED:
CLOSED: [2021-05-24 Mo 19:54]
      :PROPERTIES:
      :header-args:emacs-lisp: :tangle no
      :END:
      :LOGBOOK:
      - State "CANCELLED"  from "WAITING"    [2021-05-24 Mo 19:54] \\
        nope
...
** Online Chats
   ...
   The code in  [[file:etc/elisp/rgr-chat.el][rgr-chat]] :
