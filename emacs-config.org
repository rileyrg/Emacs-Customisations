...
***** OPEN scratchpad
      :PROPERTIES:
      :TEST:     HELLO WORLD
      :ID:       53686505-e0d6-43be-a3b8-0425035c429a
      :END:
      :LOGBOOK:
...
**** Self documenting config file, tangling
     :PROPERTIES:
     :ID:       f1698a54-3747-413c-b7c0-e8452aac6374
     :END:
...
**** CANCELLED popwin                                      :popwin:CANCELLED:
     ...
     :ID:       31f8440b-2b54-41b9-bb4c-31d937e311d9
     :END:
     :LOGBOOK:
...
** CANCELLED Web                                                  :CANCELLED:
   ...
   :PROPERTIES:
   :ID:       c20e68bb-b7c9-4515-a1df-d64e64b6ec5a
   :END:
   :LOGBOOK:
...
*** helper functions
    :PROPERTIES:
    :ID:       19ab7531-6c53-4d1e-a6b8-705e3903792c
    :END:
    #+begin_src emacs-lisp
...
*** W3M - emacs text based web browser
    :PROPERTIES:
    :ID:       79a8b4ef-639c-4e9f-9aaa-202546ddacd5
    :END:
...
*** EWW - emacs text based web browser
    :PROPERTIES:
    :ID:       79a4f568-4393-47e4-8ec0-9fdeb9324c2f
    :END:
...
***** CANCELLED [[https://github.com/iqbalansari/mu4e-alert][mu4e-alert]] to let us know of new emails :CANCELLED:
      ...
      :PROPERTIES:
      :header-args:emacs-lisp: :tangle no
      :ID:       30acfbc4-ec1e-4f59-a2e3-5fc91ba38ebf
      :END:
      :LOGBOOK:
...
***** Task                                                         :tasklist:
      :PROPERTIES:
      :ID:       5cfe71c8-50a9-4f2e-a71d-68ea476dade0
      :END:
...
*** Python                                                           :python:
    ...
    :END:
**** CANCELLED loading up python-mode                             :CANCELLED:
     CLOSED: [2021-04-02 Fr 12:59]
     :PROPERTIES:
     :header-args:emacs-lisp: :tangle no
     :END:
     :LOGBOOK:
     - State "CANCELLED"  from              [2021-04-02 Fr 12:59] \\
       use built in
     :END:
     #+begin_src emacs-lisp
...
**** virtualenvs
     :PROPERTIES:
     :ID:       b0bee2e6-a4cb-46a1-88ca-50127643d675
     :END:
***** WAITING auto-virtualenv                                       :WAITING:
      SCHEDULED: <2021-04-12 Mo>
      :PROPERTIES:
      :ID:       8608165c-a86e-4869-992c-a6809b4b014d
      :header-args:emacs-lisp: :tangle no
      :END:
      :LOGBOOK:
      - State "WAITING"    from              [2021-04-02 Fr 14:52] \\
        wait to see if pyvenv works, and if so, delete me
      - State "CANCELLED"  from              [2021-04-02 Fr 13:50] \\
        use pyvenv maybe
      :END:
      #+begin_src emacs-lisp
...
***** pyvenv
      :LOGBOOK:
      - State "WAITING"    from              [2021-04-02 Fr 14:31] \\
        waiting on whether auto venv test works better
      :END:
      #+begin_src emacs-lisp
        (use-package pyvenv
          :demand t
...
***** pyls
      ...
      #+end_src
***** CANCELLED mspyls                                            :CANCELLED:
      CLOSED: [2021-04-02 Fr 12:58]
      :PROPERTIES:
      :header-args:emacs-lisp: :tangle no
      :END:
      :LOGBOOK:
      - Note taken on [2021-04-02 Fr 13:41] \\
        cant find any way to enable flake8.
      - State "CANCELLED"  from              [2021-04-02 Fr 12:58] \\
        cant turn off lsp linter and replace with flake8
      - State "CANCELLED"  from              [2021-04-02 Fr 08:09]
      :END:
      #+begin_src emacs-lisp
        (use-package lsp-python-ms
          ...
          :hook (python-mode . (lambda ()
                                 ...
                                 (add-hook 'hack-local-variables-hook (lambda()(setq-local flycheck-checker 'python-flake8)))
                                 )))
      #+end_src
**** CANCELLED Elpy, the Emacs Python IDE                    :elpy:CANCELLED:
     CLOSED: [2021-04-02 Fr 07:41]
     :PROPERTIES:
     :ID:       dba1bfe5-5785-444e-9fb4-f2718710de60
     :header-args:emacs-lisp: :tangle no
     :END:
     :LOGBOOK:
     - State "CANCELLED"  from              [2021-04-02 Fr 07:41] \\
       cancelled by trying lsp again
     - Note taken on [2021-03-26 Fri 22:17] \\
       seems to work better than anaconda
     - State "DONE"       from "TODO"       [2021-03-26 Fri 22:17]
     - State "TODO"       from "STARTED"    [2021-03-25 Thu 20:39]
     - State "STARTED"    from "TODO"       [2021-03-25 Thu 20:38]
     - State "TODO"       from "CANCELLED"  [2021-03-25 Thu 20:34]
...
**** strace - highlight strace output
     :PROPERTIES:
     :ID:       533e9b7a-9255-4a68-8de6-0f82482edfea
     :END:
     #+begin_src emacs-lisp
