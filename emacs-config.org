...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-security.el" rgr/elisp-dir)
:END:
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-utils.el" rgr/elisp-dir)
:END:
...
:END:
#+begin_src emacs-lisp :tangle no
  (let ((lazyll-dir (expand-file-name "lazy-lang-learn" emacs-project-dir )))
    (use-package lazy-lang-learn
  ;;    :ensure  `(:repo ,lazyll-dir)
      :ensure (:repo "/home/rgr/development/projects/emacs/lazy-lang-learn")
      :bind
...
*** library                                                         :startup:
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-startup.el" rgr/elisp-dir)
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-general-config.el" rgr/elisp-dir)
:END:
**** general ui
#+begin_src  emacs-lisp
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-minibuffer.el" rgr/elisp-dir)
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-completion.el" rgr/elisp-dir)
:END:
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-org.el" rgr/elisp-dir)
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-typesetting.el" rgr/elisp-dir)
:END:
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-reference.el" rgr/elisp-dir)
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-shells.el" rgr/elisp-dir)
:END:
**** EAT
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-email.el" rgr/elisp-dir)
:END:
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-chat.el" rgr/elisp-dir)
:END:
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-programming.el" rgr/elisp-dir)
:END:
...
***** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-lsp.el" rgr/elisp-dir)
:END:
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-elisp.el" rgr/elisp-dir)
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-themes.el" rgr/elisp-dir)
:END:
**** modus themes
:PROPERTIES:
