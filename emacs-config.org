...
Raw: [[file+sys:etc/elisp/rgr-security.el][rgr/security]]
...
supereded by [[id:3e64582f-bf01-4ac1-8afb-7c4c51410be0][jinx : the enchanted spell checker]]
:PROPERTIES:
...
Raw: [[file+sys:etc/elisp/rgr-typesetting.el][rgr/typesetting]]
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-typesetting.el" elisp-dir)
:END:
...
Raw: [[file+sys:etc/elisp/rgr-kill-dwim.el][rgr/kill-dwim]]
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-kill-dwim.el" elisp-dir)
:END:
...
Raw: [[file+sys:etc/elisp/rgr-shells.el][rgr/shells]]
...
*** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-shells.el" elisp-dir)
:END:
**** EAT
...
Raw: [[file+sys:etc/elisp/rgr-email.el][rgr/email]]
...
Raw: [[file+sys:etc/elisp/rgr-programming.el][rgr/programming]]
...
:END:
****** diff-hl mode
I prefer this to [[https://github.com/emacsorphanage/git-gutter][git-gutter.el]].
#+begin_src emacs-lisp
  (use-package diff-hl
    :hook
...
Raw: [[file+sys:etc/elisp/rgr-chat.el][rgr/chat]]
#+begin_src emacs-lisp
...
***** library
:PROPERTIES:
:header-args:emacs-lisp: :tangle (expand-file-name "rgr-chat.el" elisp-dir)
:END:
...
Raw: [[file+sys:etc/elisp/rgr-themes.el][rgr/themes]]
