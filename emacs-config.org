...
***** auto-virtualenvwrapper
      ...
      #+end_src
***** CANCELLED auto-virtualenv                                   :CANCELLED:
      CLOSED: [2021-03-21 Sun 23:09]
      :PROPERTIES:
      :CUSTOM_ID: config-Programming_Language_related-Python-virtualenvs-pyenv_in_a_python_project-auto-virtualenv-32dfd407
      :header-args:emacs-lisp: :tangle no
      :END:
      :LOGBOOK:
      - Note taken on [2021-03-21 Sun 23:09] \\
        use auto-virtualenvwrapper instead
      - State "CANCELLED"  from              [2021-03-21 Sun 23:09]
      :END:
...
****** creating the env in a project directory
       ...
       #+begin_src bash
         python3 -m venv .env
       #+end_src
****** CANCELLED use dir-locals to trigger it                     :CANCELLED:
       CLOSED: [2021-03-21 Sun 22:34]
       :PROPERTIES:
       :CUSTOM_ID: config-Late_load-pyenv_in_a_python_project-use_dir-locals_to_trigger_it-5c42166b
       :END:
       :LOGBOOK:
       - State "CANCELLED"  from "TODO"       [2021-03-21 Sun 22:34]
       - State "TODO"       from              [2021-03-21 Sun 22:19]
       :END:
       which is a shitty way of dealing with it as we need it per project..
       #+begin_src emacs-lisp :tangle no
