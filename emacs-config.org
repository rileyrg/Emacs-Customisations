...
This file generates [[file:init.el::defvar bootstrap-version][init.el]] and other [[file:etc/elisp/][org files]]  using [[#Org_functionality-Self_documenting_config_file-7dfe1f94][org-babel-tangle]]
...
***** embark-consult
      :PROPERTIES:
      :CUSTOM_ID: config-Minibuffer_Enrichment_(search,_sudo_edit...)-library-Embark_Emacs_Mini-Buffer_Actions_Rooted_in_Keymaps-embark-consult-0c88a48a
      :END:
      #+begin_src emacs-lisp
...
**** CANCELLED lsp                                            :lsp:CANCELLED:
     ...
     #+begin_src emacs-lisp
       ...
       (add-hook 'python-mode-hook  (lambda ()
                                      ...
                                      (lsp)))
     #+end_src
**** CANCELLED Anaconda                                  :anaconda:CANCELLED:
     CLOSED: [2021-03-26 Fri 22:17]
     :PROPERTIES:
     :CUSTOM_ID: config-Programming_Language_related-Python-Anaconda-d30e2860
     :header-args:emacs-lisp: :tangle no
     :END:
     :LOGBOOK:
     - State "CANCELLED"  from "WAITING"    [2021-03-26 Fri 22:17] \\
       using elpy
     - State "WAITING"    from "TODO"       [2021-03-26 Fri 22:16] \\
       wait to see if elpy fails
     - State "TODO"       from "CANCELLED"  [2021-03-25 Thu 22:02]
     - State "CANCELLED"  from              [2021-03-25 Thu 20:34] \\
       keeps freezing so back on the shelf for a while
     :END:
     ...
     #+end_src
**** DONE Elpy, the Emacs Python IDE                                   :elpy:
     CLOSED: [2021-03-26 Fri 22:17]
     :PROPERTIES:
...
**** virtualenvs
     ...
     :END:
***** DONE auto-virtualenv
      CLOSED: [2021-03-26 Fri 22:15] SCHEDULED: <2021-03-23 Tue>
      :PROPERTIES:
      :CUSTOM_ID: config-Programming_Language_related-Python-virtualenvs-auto-virtualenvwrapper-bd500e27
      :END:
      :LOGBOOK:
      - State "DONE"       from "TODO"       [2021-03-26 Fri 22:15]
      ...
      #+end_src
***** DONE pyvenv in a python project
      CLOSED: [2021-03-26 Fri 22:15]
      :PROPERTIES:
      :header-args:emacs-lisp: :tangle no
      :CUSTOM_ID: config-Late_load-pyenv_in_a_python_project-245e2d3a
      :END:
      :LOGBOOK:
      - State "DONE"       from              [2021-03-26 Fri 22:15]
      :END:
...
*** SOMEDAY Dashboard                                               :WAITING:
    :PROPERTIES:
    :header-args:emacs-lisp: :tangle no
    :CUSTOM_ID: config-Startup-Dashboard-1eda176e
    :END:
    :LOGBOOK:
