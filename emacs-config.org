...
#+begin_src emacs-lisp
  (use-package ffap
    ...
    (ffap-bindings))
#+end_src
**** [[https://github.com/raxod502/selectrum][Selectrum]] provides UI for selection from candidate list      :selectrum:
:PROPERTIES:
...
#+end_src
**** [[https://github.com/raxod502/prescient.el][Prescient]] provides sorting and filtering.                    :prescient:
:PROPERTIES:
