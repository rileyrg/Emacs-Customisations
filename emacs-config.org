...
:END:
**** CANCELLED fancy-dabbrev                                      :CANCELLED:
CLOSED: [2021-07-21 Wed 11:39]
:PROPERTIES:
:ID:       63e64233-79d8-4e94-bd22-5c458416d3f1
:header-args:emacs-lisp: :tangle no
:END:
:LOGBOOK:
- State "CANCELLED"  from              [2021-07-21 Wed 11:39] \\
  hmm, how to plug dabbrev into completing read!?
:END:
[[https://github.com/jrosdahl/fancy-dabbrev][fancy-dabbrev]] works ok with vertico and alt tab emacs completion
#+begin_src emacs-lisp
...
***** org-roam
:PROPERTIES:
:ID:       0686341f-6d4d-4aef-b1bc-d34e16615674
:END:
Inspired by another System Crafters [[https://systemcrafters.cc/build-a-second-brain-in-emacs/getting-started-with-org-roam/][video]].
#+begin_src emacs-lisp
