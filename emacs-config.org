...
the server stays aive..... I think ;)  Of course if you want to revret
to the general HISTFILE then just symbolically link the prject local
.project-history to it.

#+begin_src emacs-lisp :tangle (rgr/user-elisp-file "project-external-terminal.el")
