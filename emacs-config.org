...
#+begin_src emacs-lisp
  (use-package ffap
    ...
    ( "C-x C-f" . rgr/ffap))
#+end_src
**** CANCELLED [[https://github.com/raxod502/selectrum][Selectrum]] provides UI for selection from candidate list :selectrum:CANCELLED:
CLOSED: [2023-07-30 Sun 16:08]
:PROPERTIES:
:ID:       f7f2ea39-77f2-45bd-9402-0eb09ef74b39
:header-args:emacs-lisp: :tangle no
:END:
:LOGBOOK:
- State "CANCELLED"  from              [2023-07-30 Sun 16:08] \\
  vertico supercedes selectrum
