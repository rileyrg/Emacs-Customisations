...
#+begin_src emacs-lisp
  (use-package bookmark+
    ...
    :after bookmark)
#+end_src
**** TODO waiting on replies to reddit post about bmkp vesioning
...
lldb/voltron integration to project
  ...
  #+end_src
****** CANCELLED really need to look into project root stuff      :CANCELLED:
CLOSED: [2021-07-13 Tue 00:49] SCHEDULED: <2021-07-01 Thu>
:PROPERTIES:
:DateCreated: <2021-07-01 Thu 10:32>
:END:
:LOGBOOK:
- State "CANCELLED"  from "TODO"       [2021-07-13 Tue 00:49] \\
  back to projectile
:END:
**** Project Management                                             :project:
***** CANCELLED project.el                                        :CANCELLED:
CLOSED: [2021-07-07 Wed 22:34]
:PROPERTIES:
:header-args:emacs-lisp: :tangle no
:END:
:LOGBOOK:
- State "CANCELLED"  from              [2021-07-07 Wed 22:34] \\
  back to pojectile
:END:
