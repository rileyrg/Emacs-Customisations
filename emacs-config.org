...
#+PROPERTY: header-args:emacs-lisp :tangle ~/.emacs.d/init.el :tangle-mode (identity #o444)
...
** Auto-compile
   ...
   :END:
#+begin_src emacs-lisp :tangle (expand-file-name "rgr-early-init.el" elisp-dir)
...
**** WAITING Transparency                                           :WAITING:
     :PROPERTIES:
     :header-args:emacs-lisp: :tangle no
     :END:
     :LOGBOOK:
     - State "WAITING"    from              [2021-04-15 Do 23:06] \\
       disable alpha for now - makes pop up help useless
     :END:
     #+begin_src emacs-lisp
...
***** Centaur Tabs                                                  :centaur:
      ...
      #+end_src
***** WAITING Tab Bar Mode                                   :tabbar:WAITING:
      :PROPERTIES:
      :header-args:emacs-lisp: :tangle no
      :END:
      :LOGBOOK:
      - State "WAITING"    from              [2021-04-06 Di 20:45] \\
        wait on appraisal of centaur tabs mode
      :END:
      #+begin_src emacs-lisp
...
***** .ignore for the emacs root sample
      ...
      :END:
      #+begin_src conf :tangle ~/.emacs.d/.ignore
...
****** TODO [#A] look at making get region or symbol function interactive as an exercise
...
**** EShell Config
     ...
     #+end_src
*** CANCELLED vterm                                               :CANCELLED:
    CLOSED: [2021-05-08 Sat 16:11] SCHEDULED: <2021-04-13 Tue>
    :PROPERTIES:
    :header-args:emacs-lisp: :tangle no
    :END:
    :LOGBOOK:
...

=pfap
-----END PGP MESSAGE-----
**** Emacs Slack
     :PROPERTIES:
