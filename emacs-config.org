...
** elpa package manager
   ...
   :header-args:makefile: :tangle no
   :END:
...
(if (require 'borg-elpa nil t)
  ...
  (package-initialize))
     #+end_src
**** makefile
     #+begin_src makefile :tangle no (expand-file-name "Makefile" user-emacs-directory )
...
(with-eval-after-load 'magit
  (magit-add-section-hook 'magit-status-sections-hook
    ...
    #+end_src
*** makefile
    #+begin_src makefile :tangle (expand-file-name "Makefile" user-emacs-directory )
