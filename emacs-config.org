...
#+begin_src emacs-lisp
  ...
  ;;   )
#+end_src
**** CANCELLED [[https://github.com/raxod502/ctrlf                                                   :CANCELLED:
CLOSED: [2023-10-05 Thu 23:56]
:PROPERTIES:
:header-args:emacs-lisp: :tangle no
:END:
:LOGBOOK:
- State "CANCELLED"  from              [2023-10-05 Thu 23:56] \\
  use isearch
:END:
][ctrlf searching]]
#+begin_src emacs-lisp
...
:LOGBOOK:
- State "TODO"       from              [2023-08-02 Wed 09:46]
:END:
